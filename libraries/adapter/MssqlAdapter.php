...
use MSSQL\Dialect\MssqlDialect;
use Phalcon;
...
class MssqlAdapter extends AdapterPdo implements EventsAwareInterface, AdapterInterface
{
    protected $instance;
    ...
    public function describeColumns($table, $schema = null)
    {
        ...
        foreach ($describe as $field) {
             ...
             */
            $definition['notNull'] = (0 == $field['NULLABLE']);
    ...
    {
        if (false !== strpos($descriptor['host'], ';')) {
        ...
        */
        ...
        foreach ($placeholders as $wildcard => $value) {
            ...
            if (is_array($dataTypes) && !empty($dataTypes)) {
                 ...
                 */
                $castValue;
                if (\Phalcon\Db\Column::BIND_PARAM_DECIMAL == $type) {
                 ...
                 */
                if (\Phalcon\Db\Column::BIND_SKIP == $type) {
